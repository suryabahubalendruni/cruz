from cruz_bokeh.models import *
from cruz_bokeh.address_search import *
...
def search_address(address, radius, gmaps):
...
# address = TextInput(title="Address:", value="PHD")
# month = Select(title="Month:", value="January", options=["January", "February", "March", "April", "May", "June", "July"])
...
inputs = widgetbox([address, month])
l = layout([[inputs], [d_choropleth, p_choropleth]])

curdoc().add_root(l)
curdoc().title = "Dropoff Choropleth"